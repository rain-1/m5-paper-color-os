...
def serve(route):
    ...
    if url.path=='/gallery':route.fulfill(body=html,content_type='text/html')
        ...
        route.fulfill(status=201,json=dict(path=f'/pictures/2026/09/20260916_143025_{marker}_deadbeef.p6'))
...
with sync_playwright() as p:
    ...
    assert page.locator('#files button').count()==1 # legacy path still offered
